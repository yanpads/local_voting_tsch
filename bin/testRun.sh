...
python -u runSimOneCPU.py --cpuID 1 --numRuns=1 --numCyclesPerRun=100  --numPacketsBurst 5 --burstTimestamp 20 --pkPeriod 16 --otfThreshold 0 --buffer 100 --parents=1  | tee tmp.out
